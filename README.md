...
The data you will work with is available in a single zip file here:hw1_data.zip Download hw1_data.zip.There are two data sets in this zip file, which are described below in more detail. 
